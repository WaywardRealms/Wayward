    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (classesPluginProvider != null) {
                ...
                sender.sendMessage(ChatColor.GREEN + "Melee attack: " + character.getStatValue(Stat.MELEE_ATTACK) + (classesPlugin.getLevel(character) < classesPlugin.getClass(character).getMaxLevel() ? ChatColor.GRAY + " (Next level: +" + getStatIncrease(classesPlugin.getClass(character), Stat.MELEE_ATTACK, classesPlugin.getLevel(character)) + ")" : ""));
                sender.sendMessage(ChatColor.GREEN + "Melee defence: " + character.getStatValue(Stat.MELEE_DEFENCE) + (classesPlugin.getLevel(character) < classesPlugin.getClass(character).getMaxLevel() ? ChatColor.GRAY + " (Next level: +" + getStatIncrease(classesPlugin.getClass(character), Stat.MELEE_DEFENCE, classesPlugin.getLevel(character)) + ")" : ""));
                sender.sendMessage(ChatColor.GREEN + "Ranged attack: " + character.getStatValue(Stat.RANGED_ATTACK) + (classesPlugin.getLevel(character) < classesPlugin.getClass(character).getMaxLevel() ? ChatColor.GRAY + " (Next level: +" + getStatIncrease(classesPlugin.getClass(character), Stat.RANGED_ATTACK, classesPlugin.getLevel(character)) + ")" : ""));
                sender.sendMessage(ChatColor.GREEN + "Ranged defence: " + character.getStatValue(Stat.RANGED_DEFENCE) + (classesPlugin.getLevel(character) < classesPlugin.getClass(character).getMaxLevel() ? ChatColor.GRAY + " (Next level: +" + getStatIncrease(classesPlugin.getClass(character), Stat.RANGED_DEFENCE, classesPlugin.getLevel(character)) + ")" : ""));
                sender.sendMessage(ChatColor.GREEN + "Magic attack: " + character.getStatValue(Stat.MAGIC_ATTACK) + (classesPlugin.getLevel(character) < classesPlugin.getClass(character).getMaxLevel() ? ChatColor.GRAY + " (Next level: +" + getStatIncrease(classesPlugin.getClass(character), Stat.MAGIC_ATTACK, classesPlugin.getLevel(character)) + ")" : ""));
                sender.sendMessage(ChatColor.GREEN + "Magic defence: " + character.getStatValue(Stat.MAGIC_DEFENCE) + (classesPlugin.getLevel(character) < classesPlugin.getClass(character).getMaxLevel() ? ChatColor.GRAY + " (Next level: +" + getStatIncrease(classesPlugin.getClass(character), Stat.MAGIC_DEFENCE, classesPlugin.getLevel(character)) + ")" : ""));
                sender.sendMessage(ChatColor.GREEN + "Speed: " + character.getStatValue(Stat.SPEED) + (classesPlugin.getLevel(character) < classesPlugin.getClass(character).getMaxLevel() ? ChatColor.GRAY + " (Next level: +" + getStatIncrease(classesPlugin.getClass(character), Stat.SPEED, classesPlugin.getLevel(character)) + ")" : ""));
            }
        } else {
