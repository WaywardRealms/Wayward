...
public class FireballSpell implements Spell {
	...
	public boolean use(Fight fight, Character attacking, Character defending, ItemStack weapon) {
        ...
        if (attacking.getMana() >= 5) {
            ...
            fight.sendMessage(ChatColor.YELLOW + attacking.getName() + " launched a fireball at " + defending.getName() + " dealing " + (Math.round(damage * 100D) / 100D) + " points of damage.");
            return true;
        } else {
            fight.sendMessage(ChatColor.YELLOW + attacking.getName() + " tried to form a fireball, but did not have enough mana.");
        }
		return false;
	}
