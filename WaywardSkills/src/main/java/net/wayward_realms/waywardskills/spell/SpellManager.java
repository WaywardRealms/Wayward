...
public class SpellManager {
    ...
    public SpellManager(WaywardSkills plugin) {
        this.plugin = plugin;
        addSpell(new FireballSpell(plugin));
        addSpell(new IceboltSpell(plugin));
        addSpell(new FreezeSpell(plugin));
        addSpell(new BurnSpell(plugin));
        addSpell(new EsunaSpell(plugin));
        addSpell(new MagicMissileSpell(plugin));
        addSpell(new CureSpell(plugin));
        addSpell(new MageArmourSpell(plugin));
        addSpell(new DrawSwordSpell(plugin));
        addSpell(new EmpowerSpell(plugin));
        ...
        addSpell(new FireSwordSpell(plugin));
        addSpell(new LevitationSpell(plugin));
        addSpell(new CloakOfShadowsSpell(plugin));
        addSpell(new OvergrowthSpell(plugin));
        addSpell(new LightningSwordSpell(plugin));
        addSpell(new BlizzardSpell(plugin));
        addSpell(new LightningSpell(plugin));
        addSpell(new ExplosiveSpellSpell(plugin));
        addSpell(new BlizzardSwordSpell(plugin));
