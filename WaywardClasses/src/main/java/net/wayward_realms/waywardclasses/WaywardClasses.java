...
public class WaywardClasses extends JavaPlugin implements ClassesPlugin {
    ...
    public void onEnable() {
        ...
        registerListeners(new EntityDamageListener(this), new EntityDamageByEntityListener(), new EntityDeathListener(this), new PlayerDeathListener(), new PlayerExpChangeListener(this), new PlayerJoinListener(this));
    }
